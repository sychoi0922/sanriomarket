...
<script type="text/javascript">
    ...
    function sendIt() {
        ...
        str = str.trim();
        if (!str) {
            rpwdError.textContent = '비밀번호를 입력하세요.';
            ...
            <div class="xans-element- xans-board xans-board-readpackage-4 xans-board-readpackage xans-board-4 ">
                ...
                <form name="myForm" action="" method="get" enctype="multipart/form-data">
                    <div class="ec-base-table typeWrite">
                        <table border="1" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="pname" size="60" maxlength="100" />
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">작성자</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="rpwd" name="rpwd" size="60" maxlength="100" />
                        ...
                        <br/>
                        <div> 
                            <input type="button" class="btnNormalFix sizeS " value="등록하기" onclick="sendIt();"> 
                            <input type="reset" class="btnNormalFix sizeS " value="다시입력"> 
