	...
	<div id="container">
		<div id="contents_sub">
			...
			<table style="margin: auto">
				<tr>
					<td align="center"><font size="5px" color="#636363">${dto.category }</font>
					</td>
				</tr>
			</table>
				...
				<tr height="30">
					...
					<td align="right" width="50%">
						<form action="" method="post" name="searchForm">
							...
							</select><input type="text" name="searchValue" value="">
							<input type="button" value=" 검 색 " onclick="sendIt();"></input>
						</form>
					</td>
				</tr>
			</table>
			...
			<table width="600" border="0" cellspacing="1" cellpadding="3"
				...
				<c:forEach var="dto" items="${lists}">
					...
					<b><td width="200" align="center"><a
							...
							<br /> <font color="#555555"> ${dto.subject}&nbsp;</font><br />
							<font color="E47195">${dto.price}원</font> <!--   <a href="<%=cp%>/img/delete.do?inum=${dto.inum}&pageNum=${pageNum}">삭제</a> -->
					</td></b>
