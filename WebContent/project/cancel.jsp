...
<script type="text/javascript">
	...
	function browseDate() {
		...
		f.action = "<%=cp%>/cancel/browseDate.do";
		f.submit();
			...
			<div id="contents_sub">
				...
				<div class="xans-element- xans-myshop xans-myshop-orderhistoryhead">
					<fieldset class="ec-base-box">
						<a href="<%=cp%>/cancel/cancel.do?daySelect=0"> 전체 </a> &nbsp; <a
							href="<%=cp%>/cancel/cancel.do?daySelect=1"> 오늘 </a> &nbsp; <a
							href="<%=cp%>/cancel/cancel.do?daySelect=2"> 1주일 </a> &nbsp; <a
							href="<%=cp%>/cancel/cancel.do?daySelect=3"> 1개월 </a> &nbsp; <a
							href="<%=cp%>/cancel/cancel.do?daySelect=4"> 3개월 </a> &nbsp; <a
							href="<%=cp%>/cancel/cancel.do?daySelect=5"> 6개월 </a> &nbsp; <label
							for="startDate">Start Date:</label> <input type="date"
							id="startDate" name="startDate" value="${startDateStr}" />
						&nbsp; ~ &nbsp; <label for="endDate">End Date:</label> <input
							type="date" id="endDate" name="endDate" value="${endDateStr}" />
						&nbsp;&nbsp; <input type="button" onclick="browseDate();"
							value="조회" />
						...
						<c:forEach var="dto" items="${lists }">
							<tr height="30">
								...
								<td align="center"><a href="javascript:void(0);"
									onclick="cancleOk('<%=cp %>/cancel/cancelDelete.do?pid=${dto.pid}');">
										삭제 </a></td>
